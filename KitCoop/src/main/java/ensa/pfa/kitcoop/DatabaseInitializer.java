...
public class DatabaseInitializer implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        Personnel personnel3 = personnelRepository.save((new Personnel(4l, "2023004", false, "El Haddad", "Yasmine", "Lycée", "Masclin", "https://res.cloudinary.com/deqm1j9ey/image/upload/v1680881071/Kitcoop/default_pic_bdegda.png", LocalDate.parse("1994-04-18", formatter), LocalDate.parse("2015-04-13", formatter), "", 0, "Livreur", "AJK475218B", null,"Tilila", "Agadir", LocalDate.parse("2019-01-04", formatter), "mensuelle", 60.0, false, "0644554568", "Marié(e)", 0, null, "",new ArrayList<>())));
