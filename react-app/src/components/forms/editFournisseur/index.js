...
export default function EditFournisseur({ visible, activeTab, setLoading, refetch, setRefetch, item }) {
	const fields = {
		nom: item.nom,
	...
	return (
		<div className="blur">
			<div className="container">
				...
				<header>Modifier un fournisseur</header>
