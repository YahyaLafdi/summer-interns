...
export default function AddFournisseur({ visible, activeTab, setLoading, refetch, setRefetch }) {
	const fields = {
		nom: "",
		categorie: "",
		adresse: "",
	...
	const handleFileChange = (e) => {
		...
		reader.onload = async function (e) {
			...
			if (fileName !== "Fournisseurs") {
				alert(
					'Le fichier ne concerne pas les fournisseurs, vérifier son nom ! Le nom attendu : "Fournisseurs"'
				);
				return;
			}
			...
			const allowedCategory = category.map((categorie) => categorie.key);
			const definedData = extractedData.filter((obj) => obj.nom !== undefined);

			const isValidCategory = definedData.every((obj) => allowedCategory.includes(obj.categorie));
			...
			if (isValidCategory) {
				...
				alert("Un ou plusieurs categories n'existent pas parmis la liste de catégorie.");
				return;
			}
		};
	...
	useEffect(() => {
		...
		console.log(dropArea.querySelector(".uploadHeader"));
	...
	return (
		<div className="blur">
			<div className="container">
				...
				<header>Ajouter un fournisseur</header>

				<form action="#">
					<div className="form first">
						<div className="details personal">
							<span className="title">Détails de fournisseur</span>
					...
					<div className="form second">
						<div className="details address">
							<span className="title">Details de fournisseur</span>
